            ...
            if($res==TRUE){
                ...
                if($count >= 0){
                    ...
                    <div class="profile-container">
                        ...
                        <div class="profile1">Full Name : <?php echo $full_name; ?></div>
                        <div class="profile1">Username : <?php echo $username; ?></div>
                        <div class="profile1">Gender : <?php echo $gender; ?></div>
                        <div class="profile1">Birthday : <?php echo $birthday; ?></div>
                        <div class="profile1">Address : <?php echo $address; ?></div>
                        <div class="profile1">Phone No : <?php echo $phone_no; ?></div>
