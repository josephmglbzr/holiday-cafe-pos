	...
	<?php		
		foreach ($_SESSION["cart_item"] as $item){
			...
			?>	
					...
					<input type="submit" name="submit" value="Process Order" style="background: black; color:#fff; cursor:pointer; padding: .5rem;">
...
<div id="product-grid">
	...
	<div class="container">
		<div class="inner">
			...
			<a href="seasonal-foods.php" class="content"><div>Seasonal Foods</div></a>
	...
	<h4 class="brown">Hot Coffees</h4>

	<div class="product-con">


	<?php
	$product_array = $db_handle->runQuery("SELECT * FROM tbl_food_beverages WHERE prod_category='Hot Coffees'");
