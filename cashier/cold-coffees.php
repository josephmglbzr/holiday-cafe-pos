...
<div id="shopping-cart">
	...
	<?php		
		...
		<input type="submit" name="submit3" value="Process Order">
	</form>
...
<div id="product-grid">
	...
	<h4 class="brown">Cold Coffees</h4>

	<div class="product-con">


	<?php
	$product_array = $db_handle->runQuery("SELECT * FROM tbl_food_beverages WHERE prod_category='Cold Coffees'");
