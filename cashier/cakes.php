...
<div id="shopping-cart">
	...
	<?php
			...
			<button name='submit' id='myBtn'>Generate Receipt</button>";
...
<div id="product-grid">
	...
	<h4 class="brown">Cakes</h4>

	<div class="product-con">


	<?php
	$product_array = $db_handle->runQuery("SELECT * FROM tbl_food_beverages WHERE prod_category='Cake'");
