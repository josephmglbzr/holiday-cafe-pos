...
<div id="product-grid">
	...
	<div class="container">
        <div class="inner">
			...
			<a href="cseasonal-foods.php" class="content"><div>Seasonal Food</div></a>
	...
	<h4 class="brown">Hot Tea</h4>

	<div class="product-con">


	<?php
	$product_array = $db_handle->runQuery("SELECT * FROM tbl_food_beverages WHERE prod_category='Hot Tea'");
